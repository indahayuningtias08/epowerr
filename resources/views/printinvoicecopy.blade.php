...
<body onload="MM_preloadImages('../logo.png')">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tbody>
                                ...
                                <tr class="small">
                                    ...
                                    <td width="1%">&nbsp;</td>
                                    <td colspan="3"><span
                                            class="style9"><strong>Up. {{ $invoice->up_invoice }}</strong></span></td>
                                    <td>&nbsp;</td>
                                    <td colspan="2" class="style9">&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td colspan="2">&nbsp;</td>
    ...
    <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                <td colspan="2">
                    <div align="right" class="style9" style="padding-right: 110px;">
                    <a href="https://imgbb.com/"><img src="https://i.ibb.co/tZH4mPx/ttddanstemp.png" alt="ttddanstemp" border="0"></a>
                    </div>
                </td>
            </tr>
